...
return [
    [
        ...
        'items' => [
            ...
            ['pop-utils',     'Shared tools &amp; helpers &mdash; strings, arrays, callables and more.'],
            ...
            ['pop-debug',     'A debugger with storage handlers for files, databases, loggers and HTTP.'],
        ],
    ],
    [
        'key'   => 'http',
    ...
    [
        ...
        'items' => [
            ...
            ['pop-paginator', 'Generate pagination ranges and controls.'],
    ...
    [
        ...
        'items' => [
            ['pop-queue',     'Job queues, workers and scheduled tasks &mdash; files, databases, Redis or SQS.'],
