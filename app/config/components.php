...
return [
    [
        ...
        'items' => [
            ...
            ['pop-config',    'Configuration objects, loaded from arrays or files.'],
    ...
    [
        ...
        'items' => [
            ['pop-http',      'Client and server &mdash; requests, responses, file uploads and promises.'],
            ...
            ['pop-crypt',     'Password hashing and encryption over OpenSSL, Sodium and bcrypt.'],
    ...
    [
        ...
        'title' => 'Data',
        'items' => [
            ['pop-db',        'SQL and schema builders, records and migrations &mdash; MySQL, PostgreSQL, SQLite or SQL Server.'],
            ['pop-audit',     'Application auditing &mdash; record data changes to a database or an HTTP service.'],
